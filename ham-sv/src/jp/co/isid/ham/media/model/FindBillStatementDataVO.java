...
public class FindBillStatementDataVO extends AbstractModel{
    ...
    public Object newInstance() {
        return new FindBillStatementDataVO();
    }
     ...
     */
    @XmlElement(required = true, nillable = true)
    public BigDecimal getCARSORTNO() {
     ...
     * @param val ソートNo
     */
    public void setCARSORTNO(BigDecimal val) {
     ...
     */
    @XmlElement(required = true, nillable = true)
    public BigDecimal getMEDIASORTNO() {
     ...
     * @param val ソートNo
     */
    public void setMEDIASORTNO(BigDecimal val) {
