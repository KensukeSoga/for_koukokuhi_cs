 ...
 * @author S.Fujimoto
 */
public class FindHMEstimateCreateDAO extends AbstractRdbDao {

    /** 検索条件 */
    private FindHMEstimateCreateCondition _condition = null;

    /**
     * デフォルトコンストラクタ
     */
    public FindHMEstimateCreateDAO() {
    ...
    public List<FindHMEstimateCreateVO> selectVO(FindHMEstimateCreateCondition condition) throws HAMException {
        //パラメータチェック
        if (condition == null) {
            throw new HAMException("検索エラー", "BJ-E0001");
        }
        super.setModel(new FindHMEstimateCreateVO());
        try
        {
            _condition = condition;
            return (List<FindHMEstimateCreateVO>) super.find();
