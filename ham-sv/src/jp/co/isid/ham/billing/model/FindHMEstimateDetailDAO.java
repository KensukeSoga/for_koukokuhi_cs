 ...
 * @author T.Fujiyoshi
 */
public class FindHMEstimateDetailDAO extends AbstractRdbDao {

    /** 検索条件 */
    private FindHMEstimateDetailCondition _condition = null;

    /**
     * デフォルトコンストラクタ
     */
    public FindHMEstimateDetailDAO() {
    ...
    public String getSelectSQL() {
        ...
        sql.append(" WHERE");
        sql.append(" " + Mbj06HcBumon.HCBUMONCD + " = 'S1' AND");
    ...
    public List<FindHMEstimateDetailVO> selectVO(FindHMEstimateDetailCondition condition) throws HAMException {

        //パラメータチェック
        if (condition == null) {
            throw new HAMException("検索エラー", "BJ-E0001");
        }
        super.setModel(new FindHMEstimateDetailVO());

        try {
            _condition = condition;
            return (List<FindHMEstimateDetailVO> ) super.find();
