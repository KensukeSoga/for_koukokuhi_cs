 ...
 * @author T.Fujiyoshi
 */
public class FindHCEstimateCreationCrDAO extends AbstractRdbDao {

    FindHCEstimateCreationCrCondition _condition;

    /**
     * デフォルトコンストラクタ
     */
    public FindHCEstimateCreationCrDAO() {
    ...
    public List<FindHCEstimateCreationCrVO> selectVO(FindHCEstimateCreationCrCondition condition) throws HAMException {
        //パラメータチェック
        if (condition == null) {
            throw new HAMException("検索エラー", "BJ-E0001");
        }
        super.setModel(new FindHCEstimateCreationCrVO());
        try
        {
            _condition = condition;
            return (List<FindHCEstimateCreationCrVO>) super.find();
