 ...
 * @author T.Fujiyoshi
 */
public class FindHCEstimateListTotalDAO extends AbstractRdbDao {

    FindHCEstimateListTotalCondition _condition = null;
     ...
     * デフォルトコンストラクタ
     */
    public FindHCEstimateListTotalDAO() {
    ...
    public String[] getInnerTableColumnNames() {
        return new String[]{
                ...
                ,Tbj11CrCreateData.DIVCD
                ,Tbj11CrCreateData.GROUPCD
                ,"SUM(" + Tbj11CrCreateData.GETMONEY + ") " + Tbj11CrCreateData.GETMONEY
                ,"SUM(" + Tbj11CrCreateData.PAYMONEY + ") " + Tbj11CrCreateData.PAYMONEY
        };
    }
    ...
    public List<FindHCEstimateListTotalVO> selectVO(FindHCEstimateListTotalCondition condition) throws HAMException {
      //パラメータチェック
        if (condition == null) {
            throw new HAMException("検索エラー", "BJ-E0001");
        }
        super.setModel(new FindHCEstimateListTotalVO());
        try
        {
            _condition = condition;
            return (List<FindHCEstimateListTotalVO>) super.find();
