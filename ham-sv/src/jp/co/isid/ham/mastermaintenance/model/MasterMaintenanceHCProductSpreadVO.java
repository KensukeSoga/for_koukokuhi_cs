...
public class MasterMaintenanceHCProductSpreadVO extends AbstractModel
{
    /** serialVersionUID */
     ...
     * デフォルトコンストラクタ
     */
    public MasterMaintenanceHCProductSpreadVO()
    {
    }
    ...
    {
        return new MasterMaintenanceHCProductSpreadVO();
    }
     ...
     * 仕入消費税計算区分名を設定する
     *
     * @param val 仕入消費税計算区分名
     */
    public void setCALKBNNAME(String val)
    {
