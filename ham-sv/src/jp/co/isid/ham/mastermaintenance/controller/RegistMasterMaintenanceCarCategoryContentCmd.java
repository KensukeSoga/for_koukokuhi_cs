...
import jp.co.isid.ham.mastermaintenance.model.RegistMasterMaintenanceCarCategoryContentDispVO;
...
/**
 * <P>
 * ÔíƒJƒeƒSƒŠ•R•t•\¦î•ñ“o˜^ƒRƒ}ƒ“ƒh
 * </P>
 * <P>
 * <B>C³—š—ğ</B><BR>
 ...
 * @author X
 */
public class RegistMasterMaintenanceCarCategoryContentCmd extends Command
{
    /** serialVersionUID */
    ...
    /** “o˜^ƒf[ƒ^ */
    private RegistMasterMaintenanceCarCategoryContentDispVO _vo;
     ...
     * @param vo “o˜^ƒf[ƒ^
     */
    public void setRegistVO(RegistMasterMaintenanceCarCategoryContentDispVO vo) {
        _vo = vo;
    }
