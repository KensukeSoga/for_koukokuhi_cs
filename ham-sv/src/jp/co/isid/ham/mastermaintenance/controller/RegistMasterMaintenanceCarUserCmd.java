...
import jp.co.isid.ham.mastermaintenance.model.RegistMasterMaintenanceCarUserDispVO;
 ...
 * @author X
 */
public class RegistMasterMaintenanceCarUserCmd extends Command
{
    /** serialVersionUID */
    ...
    /** “o˜^ƒf[ƒ^ */
    private RegistMasterMaintenanceCarUserDispVO _vo;
     ...
     * @param vo “o˜^ƒf[ƒ^
     */
    public void setRegistVO(RegistMasterMaintenanceCarUserDispVO vo) {
        _vo = vo;
    }
