 ...
 * @author 新HAMチーム
 */
public class Tbj25LogSozaiKanriData {

    /**
     * インスタンス生成禁止
     */
    private Tbj25LogSozaiKanriData() {
    }

    /** 素材登録変更ログ (TBJ25LOGSOZAIKANRIDATA) */
    public static final String TBNAME = "TBJ25LOGSOZAIKANRIDATA";

    /** Prefix (TBJ25_) */
    public static final String PREFIX = "TBJ25_";
