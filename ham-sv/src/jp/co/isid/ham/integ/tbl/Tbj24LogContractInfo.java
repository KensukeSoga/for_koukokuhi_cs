 ...
 * @author 新HAMチーム
 */
public class Tbj24LogContractInfo {

    /**
     * インスタンス生成禁止
     */
    private Tbj24LogContractInfo() {
    }

    /** 契約情報変更ログ (TBJ24LOGCONTRACTINFO) */
    public static final String TBNAME = "TBJ24LOGCONTRACTINFO";

    /** Prefix (TBJ24_) */
    public static final String PREFIX = "TBJ24_";
