 ...
 * @author 新HAMチーム
 */
public class Tbj29LoginUser {

    /**
     * インスタンス生成禁止
     */
    private Tbj29LoginUser() {
    }

    /** ログインユーザー (TBJ29LOGINUSER) */
    public static final String TBNAME = "TBJ29LOGINUSER";

    /** Prefix (TBJ29_) */
    public static final String PREFIX = "TBJ29_";

    /** 担当者ID (HAMID) */
    public static final String HAMID = PREFIX + "HAMID";

    /** 所属 (AFFILIATION) */
    public static final String AFFILIATION = PREFIX + "AFFILIATION";
