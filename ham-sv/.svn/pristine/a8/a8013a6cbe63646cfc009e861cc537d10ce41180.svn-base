...
public class Tbj22SeisakuhiSsCondition implements Serializable {
     ...
     * デフォルトコンストラクタ
     */
    public Tbj22SeisakuhiSsCondition() {
    }
