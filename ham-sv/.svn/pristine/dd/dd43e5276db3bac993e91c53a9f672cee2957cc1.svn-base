...
import jp.co.isid.ham.mastermaintenance.model.FindMasterMaintenanceMEU07SIKKRSPRDDispCondition;
 ...
 * @author 森
 */
public class FindMasterMaintenanceMEU07SIKKRSPRDCmd extends Command
{
    /** serialVersionUID */
    ...
    /** 検索条件 */
    private FindMasterMaintenanceMEU07SIKKRSPRDDispCondition _condition;
    ...
    public void execute() throws UserException
    {
        ...
        FindMasterMaintenanceMEU07SIKKRSPRDVO mEU07SIKKRSPRDVO = manager.getMasterMaintenanceMEU07SIKKRSPRD(_condition.getConditionMEU07SIKKRSPRD());
     ...
     */
    public void setFindCondition(FindMasterMaintenanceMEU07SIKKRSPRDDispCondition condition)
    {
