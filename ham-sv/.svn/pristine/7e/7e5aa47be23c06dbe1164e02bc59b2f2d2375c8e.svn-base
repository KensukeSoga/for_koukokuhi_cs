 ...
 * @author S.Fujimoto
 */
public class FindRdProgramRegisterManager {

    /** シングルトンインスタンス */
    private static FindRdProgramRegisterManager _manager = new FindRdProgramRegisterManager();

    /**
     * シングルトンの為、インスタンス化を禁止します
     */
    private FindRdProgramRegisterManager() {
    }
     ...
     * @return インスタンス
     */
    public static FindRdProgramRegisterManager getInstance() {
        return _manager;
    }
     ...
     */
    public FindRdProgramRegisterResult findRdProgramRegister(FindRdProgramRegisterCondition cond) throws HAMException {
        ...
        tbj37cond.setRdseqno(cond.getRdProgramSeqNo());
        result.setRdProgram(tbj37dao.selectVO(tbj37cond));
        ...
        tbj38cond.setRdseqno(cond.getRdProgramSeqNo());
        result.setRdProgramWaku(tbj38dao.findVO(tbj38cond));
        ...
        tbj39cond.setRdseqno(cond.getRdProgramSeqNo());
        result.setRdProgramStation(tbj39dao.selectVO(tbj39cond));

        //ラジオ番組登録画面素材情報
        FindRdProgramMaterialDAO rdProgramMaterialDao = FindRdProgramRegisterDAOFactory.createFindRdProgramMaterialDAOFactory();
        FindRdProgramMaterialCondition rdPgmMaterialCond = new FindRdProgramMaterialCondition();
        rdPgmMaterialCond.setTermFrom(cond.getPhaseStart());
        rdPgmMaterialCond.setTermTo(cond.getPhaseEnd());
        result.setRdProgramMaterial(rdProgramMaterialDao.findRdProgramMaterialInfo(rdPgmMaterialCond));
