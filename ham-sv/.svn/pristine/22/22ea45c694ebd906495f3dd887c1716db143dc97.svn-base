...
import jp.co.isid.ham.mastermaintenance.model.RegistMbj04KeiretsuVO;
 ...
 * @author 森
 */
public class CheckRegistMasterMaintenanceSeriesCmd extends Command
{
    /** serialVersionUID */
    ...
    /** チェックデータ */
    private RegistMbj04KeiretsuVO _vo;
    ...
    public void execute() throws UserException {
        ...
        manager.checkRegistMasterMaintenanceSeries(_vo);
     ...
     * @param vo チェックデータ
     */
    public void setCheckRegistVO(RegistMbj04KeiretsuVO vo) {
        _vo = vo;
    }
