 ...
 * @author 新HAMチーム
 */
public class Tbj18SozaiKanriData {

    /**
     * インスタンス生成禁止
     */
    private Tbj18SozaiKanriData() {
    }

    /** 素材登録 (TBJ18SOZAIKANRIDATA) */
    public static final String TBNAME = "TBJ18SOZAIKANRIDATA";

    /** Prefix (TBJ18_) */
    public static final String PREFIX = "TBJ18_";
