 ...
 *
 */
public class GetInitCmCodeIssueDocsCmd extends Command  {
	...
	public void execute() throws UserException {
		...
		MaterialRegisterResult result = manager.getInitCmCodeIssueDocsList(_condition);
        getResult().set(RESULT_KEY, result);
	}

	/**
	 * 検索条件を設定します
	 * @param condition MaterialRegisterCondition 検索条件
	 */
