...
public class Tbj03MediaMngCondition implements Serializable {
    ...
    /** 請求金額合計 */
    private BigDecimal _hmcosttotal = null;
     ...
     * 請求金額合計を設定する
     *
     * @param hmcosttotal 請求金額合計
     */
    public void setHmcosttotal(BigDecimal hmcosttotal) {
        this._hmcosttotal = hmcosttotal;
    }
