...
public class FindRdProgramResult extends AbstractServiceResult {
    ...
    /** ラジオ番組素材情報 */
    private List<Tbj38RdProgramMaterialVO> _rdProgramMaterial = null;
    /** ラジオ番組ネット局情報 */
    ...
    /**
     * ラジオ番組素材情報を取得する
     * @return List<Tbj38RdProgramMaterialVO> ラジオ番組素材情報
     */
    public List<Tbj38RdProgramMaterialVO> getRdProgramMaterial() {
        return _rdProgramMaterial;
    }

    /**
     * ラジオ番組素材情報を設定する
     * @param vo List<Tbj38RdProgramMaterialVO> ラジオ番組素材情報
     */
    public void setRdProgramMaterial(List<Tbj38RdProgramMaterialVO> vo) {
