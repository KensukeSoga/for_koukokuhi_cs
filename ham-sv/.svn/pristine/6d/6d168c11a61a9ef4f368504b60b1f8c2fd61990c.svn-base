 ...
 * @author S.Fujimoto
 */
public class FindHMEstimateMediaReportDAO extends AbstractRdbDao {
    ...
    /** 検索条件 */
    private FindHMEstimateMediaReportCondition _condition = null;

    /**
     * デフォルトコンストラクタ
     */
    public FindHMEstimateMediaReportDAO() {
    ...
    public String getSelectSQL() {
        ...
        /* 2015/01/21 請求業務変更対応 K.Soga ADD End */
        ...
        /* 2016/02/02 請求業務変更対応 K.Oki ADD Start */
        sql.append(" " + Tbj06EstimateDetail.SORTNO + ",");
        /* 2016/02/02 請求業務変更対応 K.Oki ADD End */
    ...
    public List<FindHMEstimateMediaReportVO> selectVO(FindHMEstimateMediaReportCondition condition) throws HAMException {
        //パラメータチェック
        if (condition == null) {
            throw new HAMException("検索エラー", "BJ-E0001");
        }
        super.setModel(new FindHMEstimateMediaReportVO());
        try
        {
            _condition = condition;
            return (List<FindHMEstimateMediaReportVO>) super.find();
