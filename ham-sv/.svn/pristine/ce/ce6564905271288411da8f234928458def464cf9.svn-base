...
public class Tbj11CrCreateDataVO extends AbstractModel {
    ...
    public Object newInstance() {
        return new Tbj11CrCreateDataVO();
    }
    ...
    public String getTRTHSKGYCD() {
        return (String) get(Tbj11CrCreateData.TRTHSKGYCD);
    }

    /**
     * 請求先取引先企業コードを設定する
     *
     * @param val 請求先取引先企業コード
     */
    public void setTRTHSKGYCD(String val) {
        set(Tbj11CrCreateData.TRTHSKGYCD, val);
    }
    ...
    public String getTRSEQNO() {
        return (String) get(Tbj11CrCreateData.TRSEQNO);
    }
    ...
    public void setTRSEQNO(String val) {
        set(Tbj11CrCreateData.TRSEQNO, val);
    }
    ...
    public String getHRTHSKGYCD() {
        return (String) get(Tbj11CrCreateData.HRTHSKGYCD);
    }

    /**
     * 支払先取引先企業コードを設定する
     *
     * @param val 支払先取引先企業コード
     */
    public void setHRTHSKGYCD(String val) {
        set(Tbj11CrCreateData.HRTHSKGYCD, val);
    }
    ...
    public String getHRSEQNO() {
        return (String) get(Tbj11CrCreateData.HRSEQNO);
    }
    ...
    public void setHRSEQNO(String val) {
        set(Tbj11CrCreateData.HRSEQNO, val);
    }
    ...
    public String getSTTNTID() {
        return (String) get(Tbj11CrCreateData.STTNTID);
    }
    ...
    public void setSTTNTID(String val) {
        set(Tbj11CrCreateData.STTNTID, val);
    }
    ...
    public String getSTTNTNM() {
        return (String) get(Tbj11CrCreateData.STTNTNM);
    }
    ...
    public void setSTTNTNM(String val) {
        set(Tbj11CrCreateData.STTNTNM, val);
    }
    ...
    public String getTCKEY() {
        return (String) get(Tbj11CrCreateData.TCKEY);
    }
    ...
    public void setTCKEY(String val) {
        set(Tbj11CrCreateData.TCKEY, val);
    }
    ...
    public String getTRSUBNO() {
        return (String) get(Tbj11CrCreateData.TRSUBNO);
    }
    ...
    public void setTRSUBNO(String val) {
        set(Tbj11CrCreateData.TRSUBNO, val);
    }
    ...
    public String getHRSUBNO() {
        return (String) get(Tbj11CrCreateData.HRSUBNO);
    }
    ...
    public void setHRSUBNO(String val) {
        set(Tbj11CrCreateData.HRSUBNO, val);
    }
    ...
    public String getRSTATUS() {
        return (String) get(Tbj11CrCreateData.RSTATUS);
    }
    ...
    public void setRSTATUS(String val) {
        set(Tbj11CrCreateData.RSTATUS, val);
    }
    ...
    public String getSTPKBN() {
        return (String) get(Tbj11CrCreateData.STPKBN);
    }
    ...
    public void setSTPKBN(String val) {
        set(Tbj11CrCreateData.STPKBN, val);
    }
    ...
    public String getSTTNTNMFLG() {
        return (String) get(Tbj11CrCreateData.STTNTNMFLG);
    }
    ...
    public void setSTTNTNMFLG(String val) {
        set(Tbj11CrCreateData.STTNTNMFLG, val);
    }
    ...
    public String getSTTNTNMCONFFLG() {
        return (String) get(Tbj11CrCreateData.STTNTNMCONFFLG);
    }

    /**
     * 設定担当者名確認フラグを設定する
     *
     * @param val 設定担当者名確認フラグ
     */
    public void setSTTNTNMCONFFLG(String val) {
        set(Tbj11CrCreateData.STTNTNMCONFFLG, val);
    }
    ...
    public String getSTTNTNMCONFSIKCD() {
        return (String) get(Tbj11CrCreateData.STTNTNMCONFSIKCD);
    }

    /**
     * 設定担当者名確認組織コードを設定する
     *
     * @param val 設定担当者名確認組織コード
     */
    public void setSTTNTNMCONFSIKCD(String val) {
        set(Tbj11CrCreateData.STTNTNMCONFSIKCD, val);
    }
    ...
    public String getSTTNTNMCONFHAMID() {
        return (String) get(Tbj11CrCreateData.STTNTNMCONFHAMID);
    }

    /**
     * 設定担当者名確認担当者コードを設定する
     *
     * @param val 設定担当者名確認担当者コード
     */
    public void setSTTNTNMCONFHAMID(String val) {
        set(Tbj11CrCreateData.STTNTNMCONFHAMID, val);
    }
