 ...
 * <P>
 * <B>修正履歴</B><BR>
 * ・新規作成(2013/02/27 HLC H.Watabe)<BR>
 * </P>
 * @author HLC H.Watabe
 */
...
public class FindOrderSelectVO extends AbstractModel {
    ...
    public Object newInstance() {
        return new FindAuthorityAccountBookVO();
    }
     ...
     * @param val 権限
     */
    public void setMEDIAAUTHORITY(String val) {
     ...
     * @param val 権限
     */
    public void setCARAUTHORITY(String val) {
     ...
     * @return 色刷料の値引き額
     */
    public BigDecimal getCOLORDISCOUNT() {
        return (BigDecimal) get("COLORDISCOUNT");
    }
     ...
     * @param val 色刷料の値引き額
     */
    public void setCOLORDISCOUNT(BigDecimal val) {
        set("COLORDISCOUNT", val);
    }
     ...
     * @return 指定料の値引き額
     */
    public BigDecimal getDESIGNATIONDISCOUNT() {
        return (BigDecimal) get("DESIGNATIONDISCOUNT");
    }
     ...
     * @param val 指定料の値引き額
     */
    public void setDESIGNATIONDISCOUNT(BigDecimal val) {
        set("DESIGNATIONDISCOUNT", val);
    }
    ...
    public BigDecimal getDOUBLEDISCOUNT() {
        return (BigDecimal) get("DOUBLEDISCOUNT");
    }
     ...
     * @param val 二連版料の値引き額
     */
    public void setDOUBLEDISCOUNT(BigDecimal val) {
        set("DOUBLEDISCOUNT", val);
    }
     ...
     * @return 組替料の値引き額
     */
    public BigDecimal getRECLASSIFICATIONDISCOUNT() {
        return (BigDecimal) get("RECLASSIFICATIONDISCOUNT");
    }
     ...
     * @param val 組替料の値引き額
     */
    public void setRECLASSIFICATIONDISCOUNT(BigDecimal val) {
        set("RECLASSIFICATIONDISCOUNT", val);
    }
     ...
     * @return 変形スペース料の値引き額
     */
    public BigDecimal getSPACEDISCOUNT() {
        return (BigDecimal) get("SPACEDISCOUNT");
    }

    /**
     * 変形スペース料の値引き額を設定する
     * @param val 変形スペース料の値引き額
     */
    public void setSPACEDISCOUNT(BigDecimal val) {
        set("SPACEDISCOUNT", val);
    }

    /**
     * スプリットラン料の値引き額を取得する
     * @return スプリットラン料の値引き額
     */
    public BigDecimal getSPLITRUNDISCOUNT() {
        return (BigDecimal) get("SPLITRUNDISCOUNT");
    }

    /**
     * スプリットラン料の値引き額を設定する
     * @param val スプリットラン料の値引き額
     */
    public void setSPLITRUNDISCOUNT(BigDecimal val) {
        set("SPLITRUNDISCOUNT", val);
    }
