 ...
 * @author HLC H.Watabe
 */
public class FindBeforeExpenseDAO extends AbstractSimpleRdbDao{
    ...
    public List<FindBeforeExpenseVO> selectVO(FindExpenseChangeCheckCondition cond) throws HAMException {

        super.setModel(new FindBeforeExpenseVO());
        try
        {
            _cond = cond;
            return (List<FindBeforeExpenseVO>) super.find();
