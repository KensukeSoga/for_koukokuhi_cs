 ...
 * @author 新HAMチーム
 */
public class Tbj02EigyoDaicho {

    /**
     * インスタンス生成禁止
     */
    private Tbj02EigyoDaicho() {
    }

    /** 営業作業台帳 (TBJ02EIGYODAICHO) */
    public static final String TBNAME = "TBJ02EIGYODAICHO";

    /** Prefix (TBJ02_) */
    public static final String PREFIX = "TBJ02_";
