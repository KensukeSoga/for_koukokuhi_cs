 ...
 * @author S.Fujimoto
 */
public class FindHMEstimateItemVO extends AbstractModel {

    /** serialVersionUID */
    private static final long serialVersionUID = 1L;

    /** 見積番号 */
    public static final String ESTIMATENO = "ESTIMATENO";

    /**
     * デフォルトコンストラクタ
     */
    public FindHMEstimateItemVO() {
    }
    ...
    public Object newInstance() {
        return new FindHMEstimateItemVO();
    }
     ...
     * @return String HC部門コード(Fee案件請求用)
     */
     ...
     * @param val String HC部門コード(Fee案件請求用)
     */
