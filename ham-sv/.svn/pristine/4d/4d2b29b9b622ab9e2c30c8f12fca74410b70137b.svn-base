 ...
 * @author 新HAMチーム
 */
public class Tbj36TempSozaiKanriData {

    /**
     * インスタンス生成禁止
     */
    private Tbj36TempSozaiKanriData() {
    }

    /** 仮素材登録 (TBJ36TEMPSOZAIKANRIDATA) */
    public static final String TBNAME = "TBJ36TEMPSOZAIKANRIDATA";

    /** Prefix (TBJ36_) */
    public static final String PREFIX = "TBJ36_";
