...
using Isid.NJSecurity.Sso.Filter;
...
namespace Isid.KKH.Common.KKHUtility.Security
{
    ...
    public class ConcreteInitializeFactory : AbstractInitializeFactory
    {
        ...
        {
            return KKHParameter.GetInstance().DummySecurityXmlFilePath;
        }
        ...
        public override IConnectionInfo GetConnectionInfo()
        {
            if (_connectionInfo == null)
            {
                ...
                _connectionInfo.Url = KKHParameter.GetInstance().NjSecurityServiceUrl;
                _connectionInfo.TimeOut = KKHParameter.GetInstance().NjSecurityServiceTimeout;
            }
