namespace Isid.KKH.Skyp.View.Report
{
    partial class ReportSkyp
    {
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ReportSkyp));
            ...
            this._dsReportSkyp = new Isid.KKH.Skyp.Schema.RepDSSkyp();
            ...
            ((System.ComponentModel.ISupportInitialize)(this._dsReportSkyp)).BeginInit();
            this.SuspendLayout();
            // 
            // spdReport
            // 
            ...
            this.spdReport.Location = new System.Drawing.Point(5, 46);
            ...
            this.spdReport.Size = new System.Drawing.Size(960, 595);
            this.spdReport.TabIndex = 10;
            ...
            this._spdReport_Sheet1.ColumnCount = 7;
            ...
            this._spdReport_Sheet1.ColumnHeader.Cells.Get(0, 0).Value = "媒体区分";
            this._spdReport_Sheet1.ColumnHeader.Cells.Get(0, 1).Value = "媒体名称";
            this._spdReport_Sheet1.ColumnHeader.Cells.Get(0, 2).Value = "発行／期間";
            this._spdReport_Sheet1.ColumnHeader.Cells.Get(0, 3).Value = "金額";
            this._spdReport_Sheet1.ColumnHeader.Cells.Get(0, 4).Value = "消費税額";
            this._spdReport_Sheet1.ColumnHeader.Cells.Get(0, 5).Value = "請求金額";
            this._spdReport_Sheet1.ColumnHeader.Cells.Get(0, 6).Value = "並び順";
            ...
            this._spdReport_Sheet1.Columns.Get(0).DataField = "baitaiKbn";
            this._spdReport_Sheet1.Columns.Get(0).Label = "媒体区分";
            ...
            this._spdReport_Sheet1.Columns.Get(0).Width = 290F;
            this._spdReport_Sheet1.Columns.Get(1).DataField = "baitaiMeisyo";
            this._spdReport_Sheet1.Columns.Get(1).Label = "媒体名称";
            ...
            this._spdReport_Sheet1.Columns.Get(1).Width = 250F;
            this._spdReport_Sheet1.Columns.Get(2).DataField = "hakkoKikan";
            this._spdReport_Sheet1.Columns.Get(2).Label = "発行／期間";
            ...
            this._spdReport_Sheet1.Columns.Get(2).Width = 80F;
            ...
            this._spdReport_Sheet1.Columns.Get(3).CellType = currencyCellType1;
            this._spdReport_Sheet1.Columns.Get(3).DataField = "Kingaku";
            this._spdReport_Sheet1.Columns.Get(3).Label = "金額";
            ...
            this._spdReport_Sheet1.Columns.Get(3).Width = 100F;
            ...
            this._spdReport_Sheet1.Columns.Get(4).CellType = currencyCellType2;
            this._spdReport_Sheet1.Columns.Get(4).DataField = "syohizeiGaku";
            this._spdReport_Sheet1.Columns.Get(4).Label = "消費税額";
            ...
            this._spdReport_Sheet1.Columns.Get(4).Width = 100F;
            ...
            this._spdReport_Sheet1.Columns.Get(5).CellType = currencyCellType3;
            this._spdReport_Sheet1.Columns.Get(5).DataField = "seikyuKingaku";
            this._spdReport_Sheet1.Columns.Get(5).Label = "請求金額";
            ...
            this._spdReport_Sheet1.Columns.Get(5).Width = 100F;
            this._spdReport_Sheet1.Columns.Get(6).DataField = "narabiJun";
            this._spdReport_Sheet1.Columns.Get(6).Label = "並び順";
            ...
            this._bsReport.DataSource = this._dsReportSkyp;
            // 
            // _dsReportSkyp
            // 
            this._dsReportSkyp.DataSetName = "RepDSSkyp";
            this._dsReportSkyp.SchemaSerializationMode = System.Data.SchemaSerializationMode.IncludeSchema;
            // 
            // btnSrc
            // 
            ...
            this.btnXls.Location = new System.Drawing.Point(266, 10);
            ...
            this.btnHlp.Location = new System.Drawing.Point(883, 3);
            ...
            this.btnEnd.Location = new System.Drawing.Point(926, 3);
            ...
            this.Name = "ReportSkyp";
            this.Text = "納品／請求書";
            this.Shown += new System.EventHandler(this.ReportSkyp_Shown);
            this.ProcessAffterNavigating += new Isid.NJ.View.Base.BaseForm.PrcessAffterNavigatingEventHandler(this.ReportSkyp_ProcessAffterNavigating);
            ...
            ((System.ComponentModel.ISupportInitialize)(this._dsReportSkyp)).EndInit();
        ...
        private Isid.KKH.Skyp.Schema.RepDSSkyp _dsReportSkyp;
