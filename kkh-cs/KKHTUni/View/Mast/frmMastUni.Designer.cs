namespace Isid.KKH.Uni.View.Mast
{
    partial class frmMastUni
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "frmMastUni";
            this.ProcessAffterNavigating += new Isid.NJ.View.Base.BaseForm.PrcessAffterNavigatingEventHandler(this.frmMastUni_ProcessAffterNavigating);
