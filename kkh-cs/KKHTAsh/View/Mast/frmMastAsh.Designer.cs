namespace Isid.KKH.Ash.View.Mast
{
    partial class frmMastAsh
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmMastAsh));
            ...
            this.Name = "frmMastAsh";
            this.Load += new System.EventHandler(this.frmMastAsh_Load);
            this.ProcessAffterNavigating += new Isid.NJ.View.Base.BaseForm.PrcessAffterNavigatingEventHandler(this.frmMastAsh_ProcessAffterNavigating);
