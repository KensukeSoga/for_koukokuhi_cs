...
{
    class DetailInputKmnNaviParameter : DetailFormNaviParameter
    {
        ...
        /// 広告費明細行データ 
        /// </summary>
        public Isid.KKH.Common.KKHSchema.Detail.JyutyuDataRow DataRowKmn
        {
            set { dataRow = value; }
            get { return dataRow; }
        }
