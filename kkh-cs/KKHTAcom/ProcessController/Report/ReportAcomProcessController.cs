...
using Isid.KKH.Acom.ProcessController.Report.Parser;
...
namespace Isid.KKH.Acom.ProcessController.Report
{
    ...
    ///   </list>
    /// </remarks>
    public class ReportAcomProcessController : KKHProcessController
    {
        #region インスタンス変数
        /// <summary>
        /// マスタプロセスコントローラ.
        ...
        /// データセット.
        /// </summary>
        private static Isid.KKH.Acom.Schema.RepDsAcom _dsRep;
