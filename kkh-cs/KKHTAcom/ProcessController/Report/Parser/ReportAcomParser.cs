...
namespace Isid.KKH.Acom.ProcessController.Report.Parser
{
    ...
    internal class ReportAcomParser
    {
        ...
        {
            Isid.KKH.Acom.Schema.RepDsAcom dsrep = new Isid.KKH.Acom.Schema.RepDsAcom();
            ...
            if (reportAcomVOList != null)
            {
                ...
                Isid.KKH.Acom.Schema.RepDsAcom dsAddMaster = DataSetConverter.Convert<Isid.KKH.Acom.Schema.RepDsAcom>(defs);
